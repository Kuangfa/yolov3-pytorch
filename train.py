...
def get_args():
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[32, 896], help='[min_train, max-train, test]')
...
if __name__ == '__main__':
    ...
    # opt.data=r'VOC2020/vista.data'
    # opt.cfg='cfg/yolov3.cfg'
    # opt.epochs=10
    # opt.device='cpu'
    # opt.weights='weights/yolov3.weights'

    # opt.data=r'data/vista.data'
    ...
    opt.data=r'data/vista.data'
    opt.cfg='cfg/yolov3-tiny-10cls.cfg'
    opt.epochs=1
    opt.device='cpu'
    # opt.weights='weights/best.pt'
    opt.weights='weights/yolov3-tiny.weights'

    # opt.weights='weights/yolo_weights.pth'
    # 'YOLOv3/weights/yolo_weights.pth'

    # opt.data=r'VOC2020/vista.data'
    # opt.cfg='cfg/yolov3-spp.cfg'
    # opt.epochs=10
    # opt.device='cpu'
    # opt.weights='weights/yolov3-spp.pt'
