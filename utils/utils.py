...
def print_mutation(hyp, results, bucket=''):
    # Print mutation results to evolve.txt (for use with train111111.py --evolve)
...
def plot_results_overlay(start=0, stop=0):  # from utils.utils import *; plot_results_overlay()
    # Plot training results files 'results*.txt', overlaying train111111 and val losses
    s = ['train111111', 'train111111', 'train111111', 'Precision', 'mAP@0.5', 'val', 'val', 'val', 'Recall', 'F1']  # legends
    ...
    for f in sorted(files):
        try:
            ...
            for i in range(10):
                ...
                ax[i].set_title(s[i])
                # if i in [5, 6, 7]:  # share train111111 and val loss y axes
